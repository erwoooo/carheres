...
import com.example.maptest.mycartest.Fragment.RooaFragment;
...
public class InforFragmentControlleRooa {

    private int containerId;
    private FragmentManager manager;
    private ArrayList<Fragment> fragmentArrayList;

    private static InforFragmentControlleRooa controller;

    public static InforFragmentControlleRooa getInsance(FragmentActivity activity, int containerId){
        if (controller == null){
            controller = new InforFragmentControlleRooa(activity,containerId);
        }
        return controller;
    }
    private InforFragmentControlleRooa(FragmentActivity activity, int containerId){
    ...
    private void initFragment() {
        ...
        fragmentArrayList.add(new RooaFragment());
