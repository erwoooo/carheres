...
public class SpinnergwAdapter extends BaseAdapter {
    private List<SpineBean> list;
    private Context context;

    public SpinnergwAdapter(List<SpineBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.item_gwspinner,null);
        if (convertView !=null){
