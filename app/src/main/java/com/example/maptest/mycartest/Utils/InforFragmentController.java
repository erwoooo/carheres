...
public class InforFragmentController {

    private int containerId;
    private FragmentManager manager;
    private ArrayList<Fragment> fragmentArrayList;

    private static InforFragmentController controller;

    public static InforFragmentController getInsance(FragmentActivity activity,int containerId){
        if (controller == null){
            controller = new InforFragmentController(activity,containerId);
        }
        return controller;
    }
    private InforFragmentController(FragmentActivity activity, int containerId){
