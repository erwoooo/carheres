...
import com.example.maptest.mycartest.Fragment.GwaFragment;
...
public class GwaFragmentController {

    private int containerId;
    private FragmentManager manager;
    private ArrayList<Fragment> fragmentArrayList;

    private static GwaFragmentController controller;

    public static GwaFragmentController getInsance(FragmentActivity activity, int containerId){
        if (controller == null){
            controller = new GwaFragmentController(activity,containerId);
        }
        return controller;
    }
    private GwaFragmentController(FragmentActivity activity, int containerId){
    ...
    private void initFragment() {
        ...
        fragmentArrayList.add(new GwaFragment());
